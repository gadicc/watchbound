...
The ARMv7 row describes a source-supported candidate, not a published usable
binding. Its npm namespace contains only a deprecated inert bootstrap. It
...
Its qualification is QEMU-backed rather than native-hardware evidence.
